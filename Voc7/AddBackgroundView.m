...
//  ProjectOmega
//
//  Created by Peter Rodenkirch on 28.06.12.
//  Copyright (c) 2012 Gambain. All rights reserved.
//

#import "AddBackgroundView.h"

@implementation AddBackgroundView
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGPoint midCenter = CGPointMake(CGRectGetMidX(currentBounds), CGRectGetMidY(currentBounds) - 130.0);
